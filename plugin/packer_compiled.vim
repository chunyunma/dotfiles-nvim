...
_G.packer_plugins = {
  ...
  ["vim-pandoc-syntax"] = {
    loaded = true,
    path = "/Users/chunyun/.config/local/share/nvim/site/pack/packer/start/vim-pandoc-syntax"
  },
  ["vim-repeat"] = {
    loaded = true,
  ...
  vimtex = {
    loaded = true,
    path = "/Users/chunyun/.config/local/share/nvim/site/pack/packer/start/vimtex"
  }
}
